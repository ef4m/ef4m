Visit the main course page where the course completion status block appears. Create a text block in the right-hand drawer that contains the following code:
